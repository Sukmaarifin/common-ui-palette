...
var PriusRouter = function (_a) {
    var routes = _a.routes, Component = _a.component, modes = _a.modes, rest = __rest(_a, ["routes", "component", "modes"]);
    ...
    var haveAccessTo = react_hooks_1.useLazyQuery(graphql_1.GET_ACCESS_TO, {
        ...
        if (configs_1.ENV !== 'development' &&
            ...
            haveAccessTo({
                variables: {
                    ...
                    specs: [
                        {
                            action: exports.handlerObjectKey(types_1.ROUTE_BY_PLAN, PriusNavigationBar_1.handlerPathname(routes, currentPath.filter(function (x) { return x; }))) || '/',
