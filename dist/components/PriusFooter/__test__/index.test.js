...
var PriusFooter_1 = __importDefault(require("../PriusFooter"));
describe('PriusFooter Testing', function () {
    ...
    var wrapper = enzyme_1.mount(react_1.default.createElement(styles_1.ThemeProvider, { theme: material_ui_theme_1.default },
        react_1.default.createElement(PriusFooter_1.default, null,
    ...
    it('simulates click children component', function () {
        wrapper.find(PriusFooter_1.default).find('button').simulate('click');
        expect(wrapper.find(PriusFooter_1.default).find('button').prop('onClick')).toHaveBeenCalled();
    });
});
