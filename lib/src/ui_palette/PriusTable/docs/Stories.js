...
export var basic = function () {
    return (React.createElement(PriusTable, { fields: [
            React.createElement(FieldImage, { source: "imageURLs[0]", width: "6rem", size: "small", altText: "Image of product" }),
            React.createElement(FieldText, { description: "variants[0].sku", source: "details[0].name", width: "15rem", title: "Nama" }),
            React.createElement(FieldText, { source: "brand.name", width: "12rem", title: "Toko" }),
            React.createElement(FieldNumber, { source: "stock", width: "7rem", title: "Stok" }),
            React.createElement(FieldText, { source: "publishStatus", width: "7rem", title: "Status" }),
