...
var PriusAddColumn = /** @class */ (function (_super) {
    ...
    function PriusAddColumn() {
        ...
        _this.generateNewRow = function (row) {
            ...
            if (inputElement.props.children) {
                ...
                var childElement_1 = [];
                child.forEach(function (ch, index) {
                    childElement_1.push(React.cloneElement(ch, {
                ...
                input = childElement_1.map(function (el, index) {
                    return React.createElement("span", { key: index }, el);
                });
            }
            else {
                input = React.cloneElement(inputElement, {
    ...
    PriusAddColumn.prototype.render = function () {
        ...
        return (React.createElement("div", null, data.map(function (dtRow, row) {
            return (React.createElement("div", { key: row, className: className ? className : "" },
                _this.generateNewRow(row),
                row > 0 && removeIcon ? (React.createElement("a", { onClick: function () { return _this.remove(row); } }, removeIcon)) : null));
        })));
    };
    return PriusAddColumn;
}(Component));
export default PriusAddColumn;
