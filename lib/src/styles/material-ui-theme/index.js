...
import { CheckboxSelectedIcon, CheckboxIndeterminateIcon, CheckboxUnselectedIcon, } from "../../icons";
var COLORS = {
    primary: "#1C9AEA",
    primary2: "#1478C9",
    secondary: "#DD3628",
...
var theme = createMuiTheme({
    ...
    props: {
        MuiCheckbox: {
            checkedIcon: React.createElement(CheckboxSelectedIcon, null),
            color: "default",
            indeterminateIcon: React.createElement(CheckboxIndeterminateIcon, null),
            icon: React.createElement(CheckboxUnselectedIcon, null),
        },
        MuiDialogTitle: {
