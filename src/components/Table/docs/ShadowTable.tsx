 ...
 * so the type and docgen description of `Table` wont appear via `Props`.
 *
 * In order to show the type and description of `Table`,
...
export type ShadowTableProps = TableProps;

function ShadowTable(props: ShadowTableProps) {
  return <Table {...props} />;
}
